...
XboxController xboxController = new XboxController(2); // Creates an XboxController on port 2.
  ...
  private void configureBindings() {
    ...
    joystick1.povLeft().onTrue(m_swerveDrive.getPathFromWaypoint(new Pose2d(3.235,7.186,Rotation2d.fromDegrees(-78.024))));
    joystick1.povUp().onTrue(m_swerveDrive.getPathFromWaypoint(new Pose2d(2.847,4.019,Rotation2d.fromDegrees(0))));
    joystick1.povDown().onTrue(m_swerveDrive.getPathFromWaypoint(new Pose2d(1.804,3.965,Rotation2d.fromDegrees(0))));
    joystick1.povRight().onTrue(m_swerveDrive.getPathFromWaypoint(new Pose2d(2.901,0.963,Rotation2d.fromDegrees(47.545))));
    }
